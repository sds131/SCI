...
f1 = open('/Users/sds/Downloads/result_1021/enged-country-info-full-new.csv','r',encoding='utf-8')
...
f2 = open('/users/sds/downloads/result_1021/socnet/author3_fixed.csv','r',encoding='utf-8')
...
f = open('/Users/sds/Downloads/normalize_author3_fixed.csv','w',encoding='utf-8')
csv_writer3 = csv.writer(f)
ff = open('/Users/sds/Downloads/unnormalize_author3_fixed.csv','w',encoding='utf-8')
