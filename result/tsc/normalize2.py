...
f2 = open('/users/sds/downloads/result/tsc/author2_fixed.csv','r',encoding='utf-8')
...
f = open('/Users/sds/Downloads/normalize_author2_fixed.csv','w',encoding='utf-8')
csv_writer3 = csv.writer(f)
ff = open('/Users/sds/Downloads/unnormalize_author2_fixed.csv','w',encoding='utf-8')
